...
//     // 🔹 Load all MCQs for this subject from Firestore
//     useEffect(() => {
//         let isMounted = true;
...
//                 // We collect MCQs from all chapters of this subject
...
//                 qSnap.forEach(chDoc => {
//                     const data = chDoc.data() as any;
//                     const qs: FirestoreQuestion[] = data.questions || [];
...
//                 const baseAnswers: Record<string, OptionKey | null> = {};
//                 collected.forEach(q => {
//                     baseAnswers[q.id] = null;
//                 });
//                 setAnswers(baseAnswers);
//             } catch (e: any) {
//                 console.error('[DemoMCQQuizScreen] Firestore load error', e);
//                 if (isMounted) {
...
//                 <View style={styles.center}>
//                     <Text style={{ color: '#555', textAlign: 'center' }}>
//                         No questions found in Firestore for this subject.
//                     </Text>
//                 </View>
//             )}
...
//                         <TouchableOpacity
//                             style={[styles.navBtn, nextBtnDisabled && styles.navBtnDisabled]}
//                             disabled={nextBtnDisabled}
//                             onPress={onPressNext}
//                         >
//                             <Text
